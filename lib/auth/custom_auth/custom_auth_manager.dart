...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    totemAuthUserSubject.add(
      TotemAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<TotemAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  TotemAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = TotemAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    totemAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
